      ...
      *    FORMAT US DOLLAR
       ...
       01  US-BEST-PROVINCE-FORMAT PIC $B(1)$$$,$$$,$$9.
           
       01  BEST-PROVINCE-PROFIT PIC 9(9).
       01  BEST-PROVINCE-ID  PIC 9(2).
      ...
      *       FIND BEST PROVINCE
              IF BEST-PROVINCE-PROFIT LESS THAN 
              PROVINCE-PROFIT-TOTAL(PROVINCE-INDEX) THEN
                 MOVE PROVINCE-PROFIT-TOTAL(PROVINCE-INDEX) TO 
                 BEST-PROVINCE-PROFIT
                 MOVE PROVINCE-INDEX TO BEST-PROVINCE-ID
              END-IF  
           ...
           DISPLAY "MAX PROVINCE: " BEST-PROVINCE-ID WITH NO ADVANCING 
           MOVE BEST-PROVINCE-PROFIT TO US-BEST-PROVINCE-FORMAT
           DISPLAY "   SUM INCOME: " US-BEST-PROVINCE-FORMAT
           .